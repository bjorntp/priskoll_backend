          ...
          handle -> handle.createUpdate(
              """
                  INSERT INTO products (
                      ...
                      :isFsTsAssortment,
                      :apk)
                      ON CONFLICT ("productIdNumber") DO UPDATE
                        SET
                          price = EXCLUDED.price,
                         "isBsAssortment" = EXCLUDED."isBsAssortment",
                         "updatedAt" = NOW(),
                         "isCompletelyOutOfStock" = EXCLUDED."isCompletelyOutOfStock",
                         "isTemporaryOutOfStock" = EXCLUDED."isTemporaryOutOfStock",
                         "isDiscontinued" = EXCLUDED."isDiscontinued",
                         "isSupplierTemporaryNotAvailable" = EXCLUDED."isSupplierTemporaryNotAvailable"
